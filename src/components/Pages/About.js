    ...
    return (
      <Container>
        ...
        >
          ...
          <TextDescription>
            In 1991, Hong Kong born Johnny Chin brought to Montreal a mysterious
            confectionery called Dragon’s Beard Candy, a dessert that used to
        ...
        >
          ...
          <TextDescription>
            Using corn syrup and cornstarch as its core, the once before
            hardened block of sugar is turned into 8,192 thin and delicate
            strands through stretching and doubling.
          </TextDescription>
        </TextContainer>
        <HorizontalSplitContainer
          data-aos="fade-up"
        ...
        >
          <HalfImage
            ...
            alt="Syrup"
          />
          <HalfImage src={require('assets/media/about/show.jpg')} alt="Show" />
        </HorizontalSplitContainer>
        <TextContainer
          data-aos="fade-up"
          data-aos-delay="200"
